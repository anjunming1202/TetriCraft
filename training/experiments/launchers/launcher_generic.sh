#!/bin/bash
# Generic resilient driver. args: RUN_NAME WORKTREE NODE JOBID CUDA GAMMA TOTAL WNAME
RUN_NAME=$1; WT=$2; NODE=$3; JOBID=$4; CUDA=$5; GAMMA=$6; TOTAL=$7; WNAME=$8
...
for attempt in $(seq 1 300); do
  ...
  srun --jobid=$JOBID --overlap --nodes=1 --ntasks=1 -w $NODE --cpus-per-task=20 \
    ...
    python -u training/scripts/run_training.py \
      ...
      --updates-per-step 4 --lr 1e-3 --grad-clip-norm 10 --gamma $GAMMA --batch-size 512 \
